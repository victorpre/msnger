...
var ready = function () {
    ...
    chatBox = {
        ...
        chatWith: function (conversation_id,sender_id,recipient_id) {
        ...
        createChatBox: function (conversation_id, minimizeChatBox) {
            ...
            // Adjust to footer size
            footerHeight = $(".footer-copyright").height();
            $("#chatbox_"+conversation_id).css("padding-bottom",footerHeight+20);
        ...
        checkInputKey: function (event, chatboxtextarea, conversation_id) {
          if ((event.keyCode == 13 || event.type == "click") && event.shiftKey == 0) {
